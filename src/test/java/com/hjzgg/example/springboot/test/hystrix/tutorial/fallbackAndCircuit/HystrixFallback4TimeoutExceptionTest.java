 ...
 */
public class HystrixFallback4TimeoutExceptionTest extends HystrixCommand<String> {

    private final String name;

    public HystrixFallback4TimeoutExceptionTest(String name) {
...
//		return name;
    ...
    protected String getFallback() {
        System.out.println("亲 fallback了 ");
    ...
    public static class UnitTest {
        ...
        /**
         * HystrixBadRequestException 调用程序可以捕获异常，但不会触发getFallback()
         * 其他异常则会触发fallback
         * @throws IOException
         */
        @Test
        public void testSynchronous() throws IOException {
        	try {
	        		assertEquals("fallback: Hlx", new HystrixFallback4TimeoutExceptionTest("Hlx").execute());
	        } catch(Exception e) {
